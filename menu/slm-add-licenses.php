            ...
            <form method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
                ...
                <table class="form-table">
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <select name="lic_status">    
                                ...
                                <option value="active" <?php if ($license_status == 'active') echo 'selected="selected"'; ?> >Subscribed</option>
					...
					<tr valign="top">
                        ...
                        <td><input name="paypal_email" type="text" id="paypal_email" value="<?php echo $paypal_email; ?>" size="30" readonly /><br/>License user's PayPal email address</td>
                    </tr>
                    <tr valign="top">
                        <th scope="row">Product Name</th>
                        <td><input name="company_name" type="text" id="company_name" value="<?php echo $company_name; ?>" size="30" /><br/>License's product name</td>
                    </tr>

                    <tr valign="top">
                        <th scope="row">Unique Transaction ID</th>
                        <td><input name="txn_id" type="text" id="txn_id" value="<?php echo $txn_id; ?>" size="30" readonly /><br/>The unique transaction ID associated with this license key</td>
                    </tr>
					<tr valign="top">
                        <th scope="row">Notes</th>
                        <td><textarea name="notes" type="text" id="notes" rows=8 cols=50><?php echo $notes; ?></textarea>
                        </td>
                    </tr>
                    <tr valign="top">
