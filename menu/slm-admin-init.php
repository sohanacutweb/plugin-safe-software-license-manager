...
require_once(WP_LICENSE_MANAGER_PATH . '/menu/slm-manage-mail-content.php');
...
function wp_lic_mgr_add_admin_menu() {
	...
	add_submenu_page(SLM_MAIN_MENU_SLUG, "Manage Mail Content", "Manage Mail Content", SLM_MANAGEMENT_PERMISSION, 'wp_lic_mgr_mail_cont', "wp_lic_mgr_mail_cont_menu");
