...
function lic_mgr_integration_help_menu() {
    ...
    ?>
		<div class="outgoing">
			<h2>Nanacast Outgoing API URL</h2>
			<div class="lic_mgr_code">
				<?php echo $api_query_post_url.'/wp-content/plugins/plugin-safe-software-license-manager/nanacast-listener/savenana.php'; ?>
			</div>
			<div>
				Please copy this url: <?php echo $api_query_post_url.'/wp-content/plugins/plugin-safe-software-license-manager/nanacast-listener/savenana.php'; ?> and put into external URL .
			</div>
		</div>
	<?php
